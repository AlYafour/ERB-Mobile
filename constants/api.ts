...
export const API_ENDPOINTS = {
  ...
  HR_ATTENDANCE_CHECK_IN:  '/api/hr/attendance/self-check-in/',
  HR_ATTENDANCE_CHECK_OUT: '/api/hr/attendance/self-check-out/',
  HR_ATTENDANCE_BREAK_OUT: '/api/hr/attendance/self-break-out/',
  HR_ATTENDANCE_BREAK_IN:  '/api/hr/attendance/self-break-in/',
